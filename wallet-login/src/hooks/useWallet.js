 ...
 *
 * ⚠️ 本文件与 comp7610-ticket-dapp/frontend/src/hooks/useWallet.js **逐字一致**，
 *    唯一改动是 import 路径：`../lib/contract` → `../lib/chain`
 *    （因为抽出来以后不再需要合约 ABI，链常量单独放在 chain.js）。
 *    里面没有任何一行业务代码 —— 搜索 claim / createEvent / TicketNFT 都找不到。
 */
